...
- Chapter 1: Core Dev-loop Skills, Flows, & Agent utils. Everyday spells (lock-in, polish), dev skills (layout previews, tiramisu task decomposition, git commit surgeon & chunker, mentor review), agent ops (chat log search, model quirks, minions), and expansion packs.
