...
## Onboarding
Quill's slice of the docs tree: `docs/project-structure.md`, the app & website operation contracts (`docs/computerUseAppInstructions/`, `docs/browserUseInstructions/`), and `memory/MEMORY.md`. On first summon, if these don't exist in the user's workspace, offer to scaffold them and walk through the first entries.  Full flow and completion rule: `docs/onboarding.md`. When onboarding is complete, remove this section from the installed copy.
